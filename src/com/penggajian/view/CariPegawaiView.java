 ...
 */
public class CariPegawaiView extends DialogView implements DocumentListener {
    ...
    public CariPegawaiView(MainView mainView) {
        super(mainView);
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jButtonBatal, jButtonPilih});
    ...
    private void jButtonPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPilihActionPerformed
        if (jDynamicTable.getSelectedRow() == -1) {
            ...
            masterPegawai = dynamicTableModel.get(jDynamicTable.convertRowIndexToModel(jDynamicTable.getSelectedRow()));
            dispose();
            //SetupTunjanganPegawaiDialog detailPenjualan = new SetupTunjanganPegawaiDialog(MainView.getInstance());
            //detailPenjualan.display(this, masterPegawai);
    ...
    public MasterPegawai search(Window formApp) {
    ...
    public void display(Window formApp, Object parameter) {
        ...
        MasterService service = SpringManager.getInstance().getBean(MasterService.class);
        List<MasterPegawai> list = service.getAllMasterPegawai();
        
        for (MasterPegawai value : list) {
            dynamicTableModel.add(value);
        }
        
        /*for (int i = 0; i < list.size(); i++) {
            MasterPegawai item = list.get(i);
            if (item.getId().equals(masterPegawai.getId())) {
