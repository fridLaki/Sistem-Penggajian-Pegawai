 ...
 * @author Windows
 */
public class TambahPokokHonorDialog extends DialogView {
    ...
    public TambahPokokHonorDialog(MainView mainView) {
        super(mainView);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Tambah Pokok Honor");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("TAMBAH POKOK HONOR");
    ...
    private void buttonAction(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAction
        ...
        if (source == btnBatal) {
            ...
            ph = new PokokHonor();
            ph.setStatusKepegawaian(cmbStatusKepegawaian.getSelectedItem().toString().trim());
            ph.setSubStatusKepegawaian(cmbJabatan.getSelectedItem().toString().trim());
            ph.setPendidikan(cmbPendidikan.getSelectedItem().toString().trim());
    ...
    /*public static void main(String args[]) {
        ...
        /*try {
            ...
            java.util.logging.Logger.getLogger(TambahPokokHonorDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        /*java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TambahPokokHonorDialog dialog = new TambahPokokHonorDialog(new javax.swing.JFrame(), true);
