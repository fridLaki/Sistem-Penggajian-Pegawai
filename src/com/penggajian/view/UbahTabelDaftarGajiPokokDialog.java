 ...
 * @author Windows
 */
public class UbahTabelDaftarGajiPokokDialog extends DialogView {
    ...
    public UbahTabelDaftarGajiPokokDialog(MainView mainView) {
        super(mainView);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Ubah Data Gaji Pokok");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("UBAH DATA GAJI POKOK");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmbStatusKepegawaian, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void buttonAction(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAction
        ...
        if (source == btnBatal) {
            ...
            tabelGaji.setJumlah(BigDecimal.valueOf(Long.valueOf(txtGapok.getText().replace(".", "").trim())));
            
            MasterService masterService = SpringManager.getInstance().getBean(MasterService.class);
            
            try {
                //validator.validate(mp);
                masterService.update(tabelGaji);
                dispose();
    ...
    public void display(Window formApp, Object parameter) {
        tabelGaji = (TabelGapokCapegPegawai) parameter;
        
        cmbStatusKepegawaian.setSelectedItem(tabelGaji.getStatusKepegawaian());
        //cmbJabatan.setSelectedItem(tabelGaji.getJabatan());
        cmbGolongan.setSelectedItem(tabelGaji.getGolongan());
        cmbSubGolongan.setSelectedItem(tabelGaji.getSubGolongan());
        cmbMasaKerja.setSelectedItem(tabelGaji.getMasaKerjaGolongan());
        txtGapok.setText(TextComponentUtils.formatNumber(String.valueOf(tabelGaji.getJumlah())));
        //txtGapok.setText(TextComponentUtils.formatNumber(String.valueOf(tabelGaji.getJumlah())));
